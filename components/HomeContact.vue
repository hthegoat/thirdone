<template lang="">
  ...
  <div class="container bg-gray-200 dark:bg-gray-700 px-5 py-24 mx-auto">
    <div class="flex flex-col text-center w-full mb-12">
      <h1 class="sm:text-3xl text-4xl font-bold title-font mb-4 text-gray-900 dark:text-white">Contact Me 🚀</h1>
