        ...
        <div class="h-full bg-gray-100 p-8 rounded">
          ...
          <a class="inline-flex items-center">
            ...
            <span class="flex-grow flex flex-col pl-4">
              <span class="title-font font-medium text-gray-900">Jenna Schuchardt</span>
              <span class="text-gray-500 text-sm">Communications Specialist</span>
            </span>
          </a>
        </div>
      </div>
      <div class="p-4 md:w-1/2 w-full">
        <div class="h-full bg-gray-100 p-8 rounded">
          ...
          <a class="inline-flex items-center">
            ...
            <span class="flex-grow flex flex-col pl-4">
              <span class="title-font font-medium text-gray-900">Gerardo Campbell</span>
              <span class="text-gray-500 text-sm">Project Manager, Entrepreneur</span>
            </span>
          </a>
        </div>
      </div>
      ...
      <div class="p-4 md:w-1/2 w-full">
        <div class="h-full bg-gray-100 p-8 rounded">
          ...
          <a class="inline-flex items-center">
            ...
            <span class="flex-grow flex flex-col pl-4">
              <span class="title-font font-medium text-gray-900">Marty Parker</span>
      ...
      <div class="p-4 md:w-1/2 w-full">
        <div class="h-full bg-gray-100 p-8 rounded">
          ...
          <a class="inline-flex items-center">
            ...
            <span class="flex-grow flex flex-col pl-4">
              <span class="title-font font-medium text-gray-900">David Riklan</span>
