<template>
    ...
    <div class="text-center mt-10 py-12 mb-2">
      <h1 class="sm:text-3xl text-2xl font-bold text-center title-font text-gray-900 dark:text-white mb-4">You're In Good Hands 🤝</h1>
    </div>
  ...
  <div class="container px-5 py-1 mx-auto">
    <h1 class="text-3xl font-bold title-font text-gray-900 mb-12 text-center dark:text-white">Testimonials 💭</h1>
    <div class="flex flex-wrap -m-4">
      <div class="p-4 md:w-1/2 w-full">
        <div class="h-full bg-gray-100 dark:bg-gray-500 p-8 rounded">
          <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="dark:text-white block w-5 h-5 text-gray-400 mb-4" viewBox="0 0 975.036 975.036">
          ...
          <a class="inline-flex items-center">
            ...
            <span class="flex-grow flex flex-col pl-4">
              <span class="title-font font-medium text-gray-900 dark:text-white">Jenna Schuchardt</span>
              <span class="text-gray-500 text-sm dark:text-white">Communications Specialist</span>
            </span>
          </a>
        </div>
      </div>
      <div class="p-4 md:w-1/2 w-full">
        <div class="h-full bg-gray-100 dark:bg-gray-500 p-8 rounded">
          ...
          <a class="inline-flex items-center">
            ...
            <span class="flex-grow flex flex-col pl-4">
              <span class="title-font font-medium text-gray-900 dark:text-white">Gerardo Campbell</span>
              <span class="text-gray-500 text-sm dark:text-white">Project Manager, Entrepreneur</span>
            </span>
          </a>
        </div>
      </div> 
      ...
      <div class="p-4 md:w-1/2 w-full">
        <div class="h-full bg-gray-100 dark:bg-gray-500 p-8 rounded">
          ...
          <a class="inline-flex items-center">
            ...
            <span class="flex-grow flex flex-col pl-4">
              <span class="title-font font-medium text-gray-900 dark:text-white">Marty Parker</span>
              <span class="text-gray-500 text-sm dark:text-white">Business Owner</span>
            </span>
          </a>
        </div>
      </div>
      <div class="p-4 md:w-1/2 w-full">
        <div class="h-full bg-gray-100 dark:bg-gray-500 p-8 rounded">
          ...
          <a class="inline-flex items-center">
            ...
            <span class="flex-grow flex flex-col pl-4">
              <span class="title-font font-medium text-gray-900 dark:text-white">David Riklan</span>
              <span class="text-gray-500 text-sm dark:text-white">Founder</span>
            </span>
          </a>
        </div>
      </div>
