<template lang="">
  ...
  <div class="container px-5 py-24 mx-auto">
    <div class="flex flex-col text-center w-full mb-20">
      <h1 class="sm:text-3xl text-2xl font-bold title-font mb-4 text-gray-900 dark:text-white">This Website Was Built With Javascript 💻</h1>
    ...
    <div class="flex flex-wrap -m-2">
      <div class="p-2 lg:w-1/4 md:w-1/2 w-full">
        <div class="h-full flex items-center border-gray-200 border p-4 rounded-lg">
          ...
          <div class="flex-grow">
            <a href="https://nuxtjs.org/" target="_blank"><h2 class="text-gray-900 dark:text-white title-font font-bold">Nuxt.js</h2></a>
            <p class="text-gray-500 dark:text-white">Vue Framework</p>
          </div>
        </div>
      </div>
      <div class="p-2 lg:w-1/4 md:w-1/2 w-full">
        <div class="h-full flex items-center border-gray-200 border p-4 rounded-lg">
          ...
          <div class="flex-grow">
           <a href="https://tailwindcss.com/" target="_blank"> <h2 class="text-gray-900 title-font dark:text-white font-bold">Tailwind CSS </h2></a>
            <p class="text-gray-500 dark:text-white">A Progressive CSS Framework</p>
          </div>
        </div>
      </div>
      <div class="p-2 lg:w-1/4 md:w-1/2 w-full">
