    ...
    <div class="flex flex-col items-center justify-between xl:flex-row">
      <div class="w-full max-w-xl mb-12 xl:pr-16 xl:mb-0 xl:w-7/12">
        <h2 class="max-w-lg mb-6 font-sans text-3xl font-bold tracking-tight text-white sm:text-4xl sm:leading-none">
         WooHoo You Are 99% Of The Way There  <br class="hidden md:block" />
        ...
        <div class="relative">
          ...
          <div class="relative bg-white rounded shadow-2xl p-7 sm:p-10">
            ...
            >
              ...
              <div class="mb-1 sm:mb-2">
                <label for="email" class="inline-block mb-1 text-black font-medium">Type "Accept"</label>
                <input
                  placeholder="Accept"
                  required=""
                  type="text"
              ...
              <div class="mt-4 mb-2 sm:mb-4">
                <button
                  type="submit"
                  class="inline-flex items-center justify-center w-full h-12 px-6 font-medium tracking-wide text-white transition duration-200 rounded shadow-md bg-gray-400 hover:bg-deep-purple-accent-700 focus:shadow-outline focus:outline-none"
                >
                  Accept Proposal
                </button>
              </div>
