...
<section class="text-gray-600 body-font">
    ...
    <div class="flex flex-wrap -mx-4 -mb-10 text-center">
      <div class="sm:w-1/2 mb-10 px-4">
        <div class="rounded-lg h-128 overflow-hidden">
          <img alt="content" class="object-cover object-center h-full w-full" src="https://i.ibb.co/R69hV92/th-31340404165-1560x1040.jpg">
        </div>
      ...
      <div class="sm:w-1/2 mb-10 px-4">
        <div class="rounded-lg h-128 overflow-hidden">
          <img alt="content" class="object-cover object-center h-full w-full" src="https://s3-media0.fl.yelpcdn.com/bphoto/g3rqMGOq3mKnib_CdSiC3Q/l.jpg">
        </div>
  ...
  <div class="container px-5 py-24 mx-auto">
    <div class="flex flex-wrap -mx-4 -mb-10 text-center">
      <div class="sm:w-1/2 mb-10 px-4">
        <div class="rounded-lg h-128 overflow-hidden">
          <img alt="content" class="object-cover object-center h-full w-full" src="https://i.ibb.co/RP6LzkD/168412935-2881821135426806-7230005200482607245-n.jpg">
        </div>
